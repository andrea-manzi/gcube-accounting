...
import org.gcube.messaging.accounting.portalaccountingportlet.client.AccountingCostants.Colors;
 ...
 *
 */
public class AccountingChart extends GChart {
	...
	public AccountingChart(String title,Record [] records ) {
		this.title=title;

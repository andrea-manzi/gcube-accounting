...
public class testSendMessages {
	...
	@Before
	public void setup(){
		JMSLocalProducer local = new JMSLocalProducer("/gcube");
		local.run();	
	...
	public void testSendMessageToQueue () {
		...
		try {
			record.setStartInterval(format.parse("2012-06-10 00:00:00"));
			record.setEndInterval(format.parse("2012-06-10 01:00:00"));
